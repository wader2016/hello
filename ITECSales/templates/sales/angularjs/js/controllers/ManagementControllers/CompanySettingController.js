 ...
 */
MetronicApp.controller("CompanySettingController", function ($scope,$http,authService,localStorageService,apiUrl,$location) {
    ...
    $http.get("/itecDrpWeb/templates/itecDrp/angularjs/data/ProJson.json").success(function (data) {
        $scope.getProvince = data;
    });
    $http.get("/itecDrpWeb/templates/itecDrp/angularjs/data/CityJson.json").success(function (data) {
        $scope.City = data;
    });
    $http.get("/itecDrpWeb/templates/itecDrp/angularjs/data/DistrictJson.json").success(function (data) {
        $scope.Street = data;
    });
